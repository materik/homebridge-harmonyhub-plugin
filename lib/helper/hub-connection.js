...
HubConnection.prototype._HandleConnectionOnline = function() {
	this.log("Hub went online: " + this.hubId);
	return this.refresh();
};

HubConnection.prototype._HandleConnectionOffline = function() {
	this.log('client for hub ' + this.hubInfo.uuid + ' went offline. re-establish.');
