...
let REFRESH_INTERVAL = 20 * 60 * 1000 // ms
...
Plugin.prototype.refresh = function() {
	...
	return this.loadHarmonyHubAccessories()
}

Plugin.prototype.loadHarmonyHubAccessories = function() {
	let self = this;
	self.log.debug('{Plugin} loadHarmonyHubAccessories')
...
Plugin.prototype.register = function(harmonyHubAccessories) {
	let self = this
	self.log.debug('{Plugin} registering', harmonyHubAccessories.length, 'platform accessories')
...
Plugin.prototype.configureAccessory = function(accessory) {
	...
	this.harmonyHubAccessories.push(HarmonyHubAccessory.fromAccessory(this.log, cachedAccessory))
